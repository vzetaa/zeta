 ...
 */
const nekoslife: (type: string) => Promise<any> = async (type: string) => {
 ...
 */
const waifupics: (type: string) => Promise<any> = async (type: string) => {
 ...
 */
const nekobot: (type: string) => Promise<any> = async (type: string) => {
