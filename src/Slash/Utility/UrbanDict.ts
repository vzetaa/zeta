...
export const slash: Slash = {
    ...
    run: async (client, interaction, args) => {
        ...
        const res: Response = await fetch(`https://api.urbandictionary.com/v0/define?term=${encodeURIComponent(word)}`);
        ...
        const embed: MessageEmbed = new MessageEmbed()
            ...
            .addField('RATINGS', `${grpBody.thumbs_up} 👍 || ${grpBody.thumbs_down} 👎`);
